...
export default function FaqItem({ question, answer }: FAQProps) {
  ...
  return (
    <section className='grid gap-8 text-white border-b border-gray-400 pb-8'>
      <button
        onClick={() => setIsOpen(!isOpen)}
        className="text-left text-lg md:text-2xl flex justify-between items-center w-full hover:text-gray-300 transition-colors cursor-pointer">
        {question}
